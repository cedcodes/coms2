...
--
-- Host: localhost
-- Generation Time: Dec 15, 2023 at 01:10 PM
...
INSERT INTO `tbl_notification` (`notif_id`, `user_id`, `notif_title`, `notif_details`, `is_read`, `is_shown`, `notif_to_all`, `date_added`, `date_modified`) VALUES
(3, 2, 'New Applicant - Joshua Kim Balanza', 'Hi, Juswa, you have a new application for your space (space1), for your review.', 0, 1, 0, '2023-12-15 19:48:13', NULL),
(4, 1, 'New Applicant - Juswa Caraballa', 'Hi, Joshua Kim, you have a new application for your space (space2), for your review.', 0, 1, 0, '2023-12-15 20:02:33', NULL),
(5, 1, 'Your Application is Approved', 'Hi, Joshua Kim, WELCOME! we would like to inform you that your application has been now approved.', 0, 1, 0, '2023-12-15 20:03:15', NULL),
(6, 1, 'Your Application is Rejected', 'Hi, Juswa, your application has been rejected, owner remarks - \"no requirements found!\", you can freely retry to application again until it is available, thank you.', 0, 1, 0, '2023-12-15 20:04:39', NULL),
(7, 2, 'Your Application has been Approved', 'Hi, Juswa, WELCOME! we would like to inform you that your application has been now approved.', 0, 1, 0, '2023-12-15 20:08:59', NULL);
...
VALUES(
    ...
    CONCAT('Hi, ', (SELECT first_name FROM tbl_user WHERE user_id = NEW.tenant_id), ', WELCOME! we would like to inform you that your application has been now approved.'),
    CURRENT_TIMESTAMP()
)
$$
DELIMITER ;
